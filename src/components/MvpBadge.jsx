...
// "MVP" chip shown next to a player's name when they've been a round's MVP at
// least once. Renders nothing for count 0 so it only appears for winners.
// We intentionally show just the word "MVP" (no ×N count) — the per-round tally
// wasn't always reliable, so the badge is a binary "has been MVP" mark.
