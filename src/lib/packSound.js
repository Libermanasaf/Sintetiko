...
// Autoplay policy: if the context can't start (no user gesture yet — e.g. a
// cold app open), we close it and the ceremony simply stays silent.
export function playPackSound() {
  ...
  } catch { /* no audio available — the ceremony stays silent */ }
}
